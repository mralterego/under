...
@section("title", "Страница со списком местами")
...
@section("vue")
    ...
    <script type="text/javascript" src="/front/admin/VuePlacesList.js"></script>
@endsection

@section("view")
    <div id="places_list_page" class="container">
        <div class="row">
            <div class="col s12">
                <table v-if="showTable" class="centered bordered __margin-top_xxl __border __margin-bottom_xxl">
                    ...
                    <template v-for="(item, key) in items" >
                        <tr class="hovered-row"  :id="key + '_' + item.id">
                            <td><a :href="'/admin/places/' + item.id" target="_blank">id@{{ item.id }}</a></td>
